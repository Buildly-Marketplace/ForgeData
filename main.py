...
if st.query_params.get("health_check"):
...
st.title(os.getenv("PAGE_TITLE", "ForgeData Reporting"))
st.caption("Universal Data Platform")
...
st.markdown("""
    ...
    - Make sure you're using your account credentials
